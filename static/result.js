	...
	$('.innerResult').css({
		...
		$('.innerResult').html('');
		 ...
		 if (lastresType == pastdata.gameResult) {
			  	...
			  	if (pastdata.gameResult == '1') {
			  		lastresType = '1';
			  		$('.innerResult').append('<dl class="columns sblue"><dt>남</dt><dd><div class="circle-blue res-circle">'+pastdata.rounds+'</div></dd></dl>');

			  	} else if (pastdata.gameResult == '2') {

			  		lastresType = '2';
			  		$('.innerResult').append('<dl class="columns sred"><dt>여</dt><dd><div class="circle-red res-circle">'+pastdata.rounds+'</div></dd></dl>');

			  	} else if (pastdata.gameResult == '3') {

			  		lastresType = '3';
			  		$('.innerResult').append('<dl class="columns sgreen"><dt>무</dt><dd><div class="circle-green res-circle">'+pastdata.rounds+'</div></dd></dl>');
			  	}
		  	}
